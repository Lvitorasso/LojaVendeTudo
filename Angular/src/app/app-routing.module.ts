...
const routes: Routes = [
      ...
      { path: 'compraFinalizada', component: CompraFinalizadaComponent, canActivate: [AuthGuard] },
      { path: 'minhas/Compras', component: MinhasComprasComponent, canActivate: [AuthGuard] },
